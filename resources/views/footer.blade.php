    ...
    <div class="px-8 pt-16 mx-auto lg:px-12 xl:px-16 max-w-7xl">
        <div class="flex flex-col items-center justify-between py-10 border-t border-solid lg:flex-row border-gray">
            <ul class="flex flex-wrap space-x-5 text-xs">
                <li class="mb-6 text-center flex-full lg:flex-none lg:mb-0">&copy; {{ date('Y') }} Stable Diffusion API. All rights reserved.</li>

                <li class="lg:ml-6">
                    <a href="https://stablediffusionapi.com/p/privacy-policy" target="_blank" class="relative inline-block text-black group">
            ...
            <ul class="flex items-center mt-10 space-x-5 lg:mt-0">
                ...
                <li>
                    <a href="https://twitter.com/adhik_Joshi" target="_blank" class="text-gray-600 hover:text-gray-900">
                ...
                <li>
                    <a href="https://discord.com/invite/UxqnDu7j3r" target="_blank" class="text-gray-600 hover:text-gray-900">
